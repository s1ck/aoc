...
|:--------|:----------|-------------------:|------------:|
| `Day 1` | `parsing` |     54.548 ± 1.114 |   192 MiB/s |
| `Day 1` | `pt1`     |          0.039 ± 0 |             |
| `Day 1` | `pt2`     |      0.245 ± 0.007 |             |
| `Day 2` | `parsing` |     61.739 ± 4.247 |   161 MiB/s |
| `Day 2` | `pt1`     |      2.744 ± 0.159 |             |
| `Day 2` | `pt2`     |       9.922 ± 0.62 |             |
| `Day 3` | `parsing` |     14.121 ± 0.161 |   690 MiB/s |
| `Day 3` | `pt1`     |      0.291 ± 0.001 |             |
| `Day 3` | `pt2`     |      0.129 ± 0.007 |             |
| `Day 4` | `parsing` |     47.664 ± 0.797 |   238 MiB/s |
| `Day 4` | `pt1`     |      1.192 ± 0.062 |             |
| `Day 4` | `pt2`     |      0.717 ± 0.038 |             |
| `Day 5` | `parsing` |     51.662 ± 0.956 |   191 MiB/s |
| `Day 5` | `pt1`     |          0.018 ± 0 |             |
| `Day 5` | `pt2`     |          0.018 ± 0 |             |
| `Day 6` | `parsing` |      0.402 ± 0.006 | 10189 MiB/s |
| `Day 6` | `pt1`     |      2.394 ± 0.111 |             |
| `Day 6` | `pt2`     |       5.333 ± 0.36 |             |
| `Day 7` | `parsing` |     43.091 ± 0.255 |   267 MiB/s |
| `Day 7` | `pt1`     |      0.473 ± 0.011 |             |
| `Day 7` | `pt2`     |      0.068 ± 0.002 |             |
| `Day 8` | `parsing` |       4.543 ± 0.08 |  2179 MiB/s |
| `Day 8` | `pt1`     |   303.305 ± 22.128 |             |
| `Day 8` | `pt2`     | 1570.395 ± 123.655 |             |
